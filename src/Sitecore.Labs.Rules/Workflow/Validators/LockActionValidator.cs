...
namespace Sitecore.Labs.Rules.Workflow.Validators
{
    public class LockActionValidator : StandardValidator
    {
        protected override ValidatorResult Evaluate()
        {
            ...
            var lockItem = rules.Rules.Any(r => r.Actions.Any(a => a.GetType() == typeof(LockItemAction<WorkflowRuleContext>)));
